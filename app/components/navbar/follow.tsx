...
const sections = ['experience','projects', 'skill', 'contact'];
...
const Follow = () => {
  ...
  const openAnimation = () => {
    ...
    gsap.fromTo(
      ['.homes', '.projects', '.experience', '.skill', '.contact'],
      {
        opacity: 0,
      },
      {
  ...
  return (
    ...
    >
      ...
      <ScrollLink
        ...
        <ScrollLink
          className='skill cursor-pointer text-light-general opacity-0  transition-all hover:scale-105 hover:text-light-subtitle dark:text-dark-general dark:hover:text-dark-subtitle'
          to='skill'
          spy
          smooth
          offset={-90}
          duration={500}
          onSetActive={handleActive}
          onClickCapture={() => handleActive('skill')}
          onMouseEnter={() => handleHover('skill')}
          onMouseLeave={() => handleExit('skill')}
        >
          <section className='flex items-center gap-4'>
            <Layers3 />
            Skills
        ...
        <ScrollLink
          ...
          duration={500}
          onSetActive={handleActive}
          onClickCapture={() => handleActive('contact')}
